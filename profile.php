...
?>
 ...
 <div class="card ">
   <div class="card-header">
          <h3>Thông tin người dùng <span class="float-right"> <a href="index.php" class="btn btn-primary">Quay lại</a> </h3>
        </div>
        <div class="card-body">
          ...
          <form class="" action="" method="POST">
              ...
              ">
                ...
                <?php }elseif($getUinfo->roleid == '2'){?>
                  ...
                  <option value="2" selected='selected'>Người chỉnh sửa</option>
                  <option value="3">Người dùng</option>
                <?php }elseif($getUinfo->roleid == '3'){?>
                  <option value="1">Admin</option>
                  <option value="2">Người chỉnh sửa</option>
                  <option value="3" selected='selected'>Người dùng</option>
